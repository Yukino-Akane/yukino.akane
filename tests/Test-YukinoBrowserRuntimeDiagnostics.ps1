...
Assert-True $localStateText.Contains("browser-runtime-activity-log") "Local diagnostics should emit a named matched Browser runtime activity check."
Assert-True $localStateText.Contains("Find-BrowserRuntimeActivityLog") "Local diagnostics should match Browser runtime activity start/end log lines by turnId."
Assert-True $localStateText.Contains("captured turn route") "Local diagnostics should inspect Browser turn start logs."
Assert-True $localStateText.Contains("ended browser use turn route") "Local diagnostics should inspect Browser turn completion logs."
